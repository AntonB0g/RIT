...
// modified by: S. Ciccarelli 02/19/2023 -- Modified references/plot info to Lab #5
...
DATATYPE bvl[16] = {100, 200, 20000, 155, 156, 157, 100, 10,  25500, 12767, 12768, 12769, 12770, 1000000000, 147483649,  147483638};

void setup()
{
  Serial.begin(9600);
  Serial.println(F("Lab 5 datatypes 2225"));
  Serial.println(F("\nEnter 'g' to go ....."));
